package fr.insa.cours.cpoo.coffee;

import fr.insa.cours.cpoo.coffee.machine.CoffeeMachine;
import fr.insa.cours.cpoo.coffee.machine.exception.CannotMakeCremaWithSimpleCoffeeMachine;
import fr.insa.cours.cpoo.coffee.machine.exception.CoffeeTypeCupDifferentOfCoffeeTypeTankException;
import fr.insa.cours.cpoo.coffee.machine.exception.LackOfWaterInTankException;
import fr.insa.cours.cpoo.coffee.machine.exception.MachineNotPluggedException;
import fr.insa.cours.cpoo.coffee.storage.cupboard.FabricCupboardContainer;
import fr.insa.cours.cpoo.coffee.storage.cupboard.coffee.type.CoffeeType;
import fr.insa.cours.cpoo.coffee.storage.cupboard.container.Container;
import fr.insa.cours.cpoo.coffee.storage.cupboard.container.Cup;
import fr.insa.cours.cpoo.coffee.storage.cupboard.container.Mug;
import fr.insa.cours.cpoo.coffee.storage.cupboard.exception.CupNotEmptyException;
import fr.insa.cours.cpoo.coffee.storage.cupboard.exception.ExceptionContainerCreation;
